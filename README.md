...
- **Accélérer** la mise en relation grâce à l'Intelligence Artificielle.

## 🛠 Technologies utilisées
- **Frontend** : React 19, TypeScript, Tailwind CSS.
- **Backend/Base de données** : Supabase (Auth, DB, Storage, Realtime).
...
4.  **Assistant IA** : 
    - Résumé automatique des longs posts.
    - Recherche intelligente de partenaires de projet basée sur les compétences.

...
const CreateGroupPost: React.FC<CreateGroupPostProps> = ({ groupId, onPostCreated }) => {
  ...
  const handlePost = async (e?: React.MouseEvent) => {
    ...
    try {
      ...
      onPostCreated(data as GroupPost);
    } catch (err: any) {
      ...
      <div className="space-y-4">
        ...
        {previewUrl && (
          <div className="relative inline-block">
            <img
              src={previewUrl}
              alt="Aperçu"
              className="rounded-2xl max-h-48 w-auto shadow-md border border-slate-100"
            />
            <button
              type="button"
        ...
        <div className="flex justify-between items-center pt-3 border-t border-slate-50">
          ...
          <button
            ...
            className="bg-isig-orange text-white font-black py-3.5 px-8 rounded-2xl transition-all disabled:opacity-50 flex items-center shadow-lg uppercase tracking-widest text-[10px] active:scale-95"
          >
